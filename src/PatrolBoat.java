...
public class PatrolBoat {
    final static public int length = 2;
    private Point point;
    private Direction direction;
    private Point[] points = new Point[length];
    public boolean sunk = false;

    public PatrolBoat(Point point, Direction direction) {
        this.point = point;
    ...
    public boolean outOfRange(Carrier carrier, BattleShip battleShip, Cruiser cruiser, Submarine submarine){
        for (Point point1:points) {
            ...
            for (Point point2:submarine.getPoints()) {
                if ((point2.equals(point1))){
                    return true;
                }
            }
